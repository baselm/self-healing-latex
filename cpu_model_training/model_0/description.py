...
config ={
  ...
  'modelParams' : {'tmParams': {'minThreshold': 10, 'activationThreshold': 12, 'pamLength': 2}, 'sensorParams': {'encoders': {u'cpu': {'maxval': 100.0, 'name': 'cpu', 'clipInput': True, 'minval': 0.0, 'n': 53, 'fieldname': 'cpu', 'w': 21, 'type': 'ScalarEncoder'}}}, 'spParams': {'synPermInactiveDec': 0.0003}, 'clParams': {'alpha': 0.005418683987937205}},
