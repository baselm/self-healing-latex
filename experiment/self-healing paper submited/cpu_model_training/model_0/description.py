...
config ={
  ...
  'modelParams' : {'tmParams': {'minThreshold': 11, 'activationThreshold': 15, 'pamLength': 1}, 'sensorParams': {'encoders': {u'cpu': {'maxval': 100.0, 'name': 'cpu', 'clipInput': True, 'minval': 0.0, 'n': 113, 'fieldname': 'cpu', 'w': 21, 'type': 'ScalarEncoder'}}}, 'spParams': {'synPermInactiveDec': 0.01842727272727273}, 'clParams': {'alpha': 0.081836363636363638}},
