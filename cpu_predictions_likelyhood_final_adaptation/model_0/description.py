...
config ={
  ...
  'modelParams' : {'tmParams': {'minThreshold': 10, 'activationThreshold': 13, 'pamLength': 2}, 'sensorParams': {'encoders': {u'cpu': {'maxval': 100.0, 'name': 'cpu', 'clipInput': True, 'minval': 0.0, 'n': 147, 'fieldname': 'cpu', 'w': 21, 'type': 'ScalarEncoder'}}}, 'spParams': {'synPermInactiveDec': 0.075075000000000003}, 'clParams': {'alpha': 0.025075000000000004}},
