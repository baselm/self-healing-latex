...
\author[1]{Basel Magableh*}

\author[2]{Luca Longo}

 
\authormark{Magableh B. \textsc{et al}}


\address[1]{\orgdiv{DIT}, \orgname{Dublin Institute of Technology}, \orgaddress{\state{Dublin}, \country{Ireland}}}

\address[2]{\orgdiv{DIT}, \orgname{Dublin Institute of Technology}, \orgaddress{\state{Dublin}, \country{Ireland}}}


\corres{*Basel Magableh, Dublin Institute of Technology Dublin, Ireland. \email{basel.magableh@dit.ie}}
...
\keywords{Self Healing, MicoroServices Architecture, Anomaly detection, Run- time configuration}

\jnlcitation{\cname{%
\author{Basel Magableh}, and 
\author{Luca Longo}} (\cyear{2018}), 
\ctitle{Self Healing Microservices Architecture: A case study in Docker Swarm Cluster}, \cjournal{Software: Practice and Experience} <year> <vol> Page <xxx>-<xxx>}

\footnotetext{\textbf{Self Healing Microservices Architecture:} Magableh B. et al.}
...
\begin{figure}[!ht] 
\centering
\includegraphics[scale=0.25]{demand}
...
\begin{figure}[!ht] 
\centering
\includegraphics[scale=0.3]{changes}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.5]{ScalingService}
